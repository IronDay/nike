    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-coral-red inline-block mt-3 me-3">Nike</span>
          Shoes
        </h1>
        <p
      ...
      >
        ...
        />
        <div
          className="flex items-center justify-center sm:gap-6 gap-4
        absolute -bottom-[5%] sm:left-[15%] max-sm:px-6"
        >
          {shoes.map((shoe) => (
